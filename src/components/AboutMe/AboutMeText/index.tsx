 ...
 return (
  <>
   ...
   <p className="s:text-sm lg:text:6xl xl:text-4xl">
    ...
    <strong>créativité</strong> et de ma <strong>singularité</strong> étant
    enfant, j&apos;ai donc professionnalisé ce que je sais faire de{" "}
    <strong>meilleur</strong>.
    <br />
    <br />
    Durant mon congé parental, j&apos;étais certaine d&apos;une seule chose
    &quot;<strong>Je ne retournerai pas au bureau&quot;</strong>.
    <br />
    <br />
    ...
    <strong>j&apos;ai gagné 10 ans dans ma vie</strong> professionnelle et
    personnelle.
    <br />
    <br />
    ...
    <br />
    <br />
    Etre en <strong>confiance</strong> permet{" "}
    <strong>
    ...
    <br />
    <br />
    Je m&apos;investis pour que chaque personne{" "}
    <strong>
     exprime son plein potentiel singulier et créatif, l&apos;assume, le déploie
     et face la différence.
    </strong>
    <br />
    <br />
